<template>
  <div class="app-container">
    ...
    <div class="detail-wrapper">
      <el-form ref="protocolFormRef" :model="protocolForm" :rules="rules" label-width="100px">
        ...
        <el-form-item label="协议内容" prop="content">
          <WangEditor v-model="protocolForm.content" placeholder="请输入协议内容" />
        </el-form-item>
...
<script setup>
  ...
  // 表单校验规则
  const rules = {
    categoryId: [{ required: true, message: '请选择协议标题', trigger: 'change' }],
